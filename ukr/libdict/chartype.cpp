...
# endif  // LIBMORPH_NAMESPACE
  ...
  // Characters in range 0x30 - 0x7f
    ...
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_CAPITAL, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    ...
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_REGULAR, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
  ...
  // Characters in range 0xA0 - 0xBF
    CT_INVALID, CT_INVALID, CT_INVALID, CT_INVALID,
    CT_INVALID, CT_CAPITAL, CT_INVALID, CT_INVALID, // Ґ
    CT_INVALID, CT_INVALID, CT_CAPITAL, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_CAPITAL, // Є, Ї
    CT_INVALID, CT_INVALID, CT_CAPITAL, CT_REGULAR,
    CT_REGULAR, CT_INVALID, CT_INVALID, CT_INVALID, // І, і, ґ
    CT_INVALID, CT_INVALID, CT_REGULAR, CT_INVALID,
    CT_INVALID, CT_INVALID, CT_INVALID, CT_REGULAR, // є, ї
  // Characters in range 0xC0 - 0xDF, cyrillic capitals
    ...
    CT_CAPITAL, CT_CAPITAL, CT_CAPITAL, CT_CAPITAL,
    CT_CAPITAL, CT_CAPITAL, CT_CAPITAL, CT_CAPITAL,
    CT_CAPITAL, CT_CAPITAL, CT_INVALID, CT_INVALID,
    CT_CAPITAL, CT_INVALID, CT_CAPITAL, CT_CAPITAL, // Ъ, Ы, Э
  // Regular characters in range 0xE0 - 0xFF
    ...
    CT_REGULAR, CT_REGULAR, CT_REGULAR, CT_REGULAR,
    CT_REGULAR, CT_REGULAR, CT_REGULAR, CT_REGULAR,
    CT_REGULAR, CT_REGULAR, CT_INVALID, CT_INVALID,
    CT_REGULAR, CT_INVALID, CT_REGULAR, CT_REGULAR  // ъ, ы, э
  };
